...
const Impianti = () => {
  ...
  const handleAddMacchinario = async (macchinario) => {
    await macchinarioService.addMacchinario(id, macchinario);
    setMacchinari([...macchinari, macchinario]);
    setShowForm(false);
  };
  ...
  return (
     ...
     <div className='container-impianti'> 
